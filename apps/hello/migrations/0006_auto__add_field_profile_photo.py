...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'hello_profile', 'photo',
                      self.gf('django.db.models.fields.files.ImageField')(default='pictures/notfound.jpg', max_length=100),
                      keep_default=False)
    ...
    models = {
        ...
        u'hello.profile': {
            ...
            'photo': ('django.db.models.fields.files.ImageField', [], {'default': "'pictures/notfound.jpg'", 'max_length': '100'}),
