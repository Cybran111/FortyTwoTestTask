...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'hello_dbaction', (
            ...
            ('model_object', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'hello', ['DbAction'])


        # Changing field 'Profile.photo'
        db.alter_column(u'hello_profile', 'photo', self.gf('django_resized.forms.ResizedImageField')(max_length=100))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Profile.photo'
        db.alter_column(u'hello_profile', 'photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
    ...
    models = {
        ...
        u'hello.dbaction': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'model_object': ('django.db.models.fields.TextField', [], {})
        },
        u'hello.profile': {
            ...
            'photo': ('django_resized.forms.ResizedImageField', [], {'default': "'pictures/notfound.png'", 'max_length': '100'}),
